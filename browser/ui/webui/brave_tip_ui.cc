...
void TipMessageHandler::RegisterMessages() {
  ...
  web_ui()->RegisterMessageCallback(
      ...
      base::BindRepeating(
          &TipMessageHandler::GetAutoContributeAmount,
          base::Unretained(this)));

  web_ui()->RegisterMessageCallback(
      "setAutoContributeAmount",
      base::BindRepeating(
          &TipMessageHandler::SetAutoContributeAmount,
          base::Unretained(this)));

  web_ui()->RegisterMessageCallback(
      "getAdsPerHour",
      base::BindRepeating(
          &TipMessageHandler::GetAdsPerHour,
          base::Unretained(this)));

  web_ui()->RegisterMessageCallback(
      "setAdsPerHour",
      base::BindRepeating(
          &TipMessageHandler::SetAdsPerHour,
          base::Unretained(this)));
...
void TipMessageHandler::GetAutoContributeAmount(const base::ListValue* args) {
  ...
  rewards_service_->GetAutoContributionAmount(base::Bind(
      &TipMessageHandler::GetAutoContributeAmountCallback,
      weak_factory_.GetWeakPtr()));
}
